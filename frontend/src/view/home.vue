<template>
  <a-card title="首页" style="padding: 10px">
    ...
    <template v-if="isAdmin">
      <a-card title="平台订单交付数量分布" size="small" style="margin-bottom: 20px;">
        <div ref="platformChartRef" style="width: 100%; height: 400px;"></div>
      </a-card>

      <a-card title="独立站订单销量" size="small">
    ...
    <template v-else>
      <a-row :gutter="16">
        <a-col :span="12">
          <a-card :title="`独立站销售额 (${currencySymbol})`" style="text-align: center;">
        ...
        <a-col :span="12">
          <a-card title="Jumia订单交付数" style="text-align: center;">
